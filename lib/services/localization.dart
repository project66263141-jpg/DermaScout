...
class AppLocalization {
  static const Map<String, Map<String, String>> _uiStrings = {
    'en': {
      ...
      'no_scans': 'No scan history recorded yet.',
    ...
    'hi': {
      ...
      'no_scans': 'अभी तक कोई स्कैन इतिहास रिकॉर्ड नहीं किया गया है।',
    ...
    'kn': {
      ...
      'history_title': 'ಸ್ಕ್ಯಾನ್ ಇತಿಹಾಸ',
      'no_scans': 'ಇನ್ನೂ ಯಾವುದೇ ಸ್ಕ್ಯಾನ್ ಇತಿಹಾಸ ದಾಖಲಾಗಿಲ್ಲ.',
